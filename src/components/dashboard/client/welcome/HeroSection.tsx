...
export const HeroSection = ({
  ...
  return <div className="relative bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 text-white rounded-2xl p-8 shadow-2xl overflow-hidden">
      ...
      <div className="relative flex items-center justify-between">
        <div className="space-y-4">
          ...
          <p className="text-xl text-blue-100 max-w-2xl">Seu portal de conteúdo personalizado está pronto. Explore seus vídeos, descubra novos serviços para auxiliar na sua operação.</p>
