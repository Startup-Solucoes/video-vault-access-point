  ...
  return (
    <div className="space-y-8 max-w-7xl mx-auto">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-4 pt-4">
              <Button 
                ...
                className="bg-white text-blue-600 hover:bg-blue-50 font-semibold px-6 py-3 rounded-xl shadow-lg hover:shadow-xl transition-all"
              >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="group hover:shadow-xl transition-all duration-300 border-0 bg-gradient-to-br from-blue-50 to-blue-100 cursor-pointer" onClick={onNavigateToVideos}>
