...
export const ClientSidebar = ({
  ...
  return <div className="w-80 border-r border-gray-200 bg-white flex flex-col h-full">
      {/* Header */}
      <div className="border-b border-gray-100 bg-gradient-to-r from-gray-50 to-gray-100 p-6 rounded-lg">
      ...
      <div className="flex-1 px-4 py-6">
        <div>
          ...
          <div className="space-y-2">
            {menuItems.map(item => <button key={item.view} onClick={() => onViewChange(item.view)} className={`group relative p-3 rounded-xl transition-all duration-200 w-full text-left ${currentView === item.view ? 'bg-gray-700 text-white shadow-lg shadow-gray-700/25' : 'hover:bg-gray-50 hover:shadow-sm'}`}>
