...
export const AdvertisementBanner = ({
  ...
  return <Card className="overflow-hidden hover:shadow-xl transition-all duration-300 cursor-pointer border-l-4 border-l-yellow-500 bg-gradient-to-r from-yellow-50 to-yellow-100 hover:from-yellow-100 hover:to-yellow-200" onClick={handleClick}>
      <CardContent className="p-0">
        <div className="flex items-center h-28 sm:h-32">
          ...
          <div className="w-28 h-28 sm:w-32 sm:h-32 bg-gradient-to-br from-yellow-100 via-yellow-200 to-yellow-300 flex items-center justify-center flex-shrink-0 relative overflow-hidden">
            {advertisement.image_url ? <img src={advertisement.image_url} alt={advertisement.title} className="w-full h-full object-cover transition-transform duration-300 hover:scale-105" onError={e => {
            ...
            <div className="flex justify-between items-start h-full">
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-2">
                  {advertisement.price && <span className="text-sm font-bold text-yellow-600 bg-yellow-100 px-3 py-1 rounded-full">
              ...
              <Button size="sm" className="ml-3 flex-shrink-0 bg-yellow-500 hover:bg-yellow-600 text-white border-0 shadow-lg hover:shadow-xl transition-all duration-300" onClick={e => {
              e.stopPropagation();
              handleClick();
            }}>
